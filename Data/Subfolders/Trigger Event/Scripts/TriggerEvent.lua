...
local OBJECT_TO_CHECK = script:GetCustomProperty("ObjectToCheck"):WaitForObject()
...
function IsObjectStateSatisfied()
    ...
    return OBJECT_TO_CHECK.context.SomeStateCondition
end
...
-- Function to handle interaction with the trigger (optional)
function OnInteracted(trigger, player)
    -- Handle interaction with the trigger (if needed)
end
